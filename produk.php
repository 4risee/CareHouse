...
<body>
    ...
    <section class="breadcrumb-section set-bg" data-setbg="alkes/ruang.jpg">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-7">
                    <div class="filter__item">
                        ...
                        <div class="row col-lg-12 col-md-6 col-sm-6">
                            ...
                            <div class="product__item mr-5">
                                <div class="product__item__pic set-bg" data-setbg="image/<?php echo $produk['foto']; ?>">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#"><?php echo $produk['nama']; ?></a></h6>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <ul>
                            <li>Address: Jln.Bantaran Gg.VD No.21</li>
                            <li>Phone: +62 11.188.888</li>
                            <li>Email: CareMart@gmail.com</li>
                        </ul>
                    </div>
                </div>
